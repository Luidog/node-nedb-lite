...
(function (local) {
    ...
    (function () {
        ...
        // jslint-hack
        nop(pathDirname, require);
        // init global
        local.global = local.modeJs === 'browser'
            ? window
            : global;
        pathDirname = function (path) {
            var dir = (/^(.+\/(?!$)|\/)?((?:.+?)?(\.[^.]*)?)$/).exec(path)[1] || '';
            return !dir
                // No dirname
                ? '.'
...
storage.crashSafeWriteFile = function (filename, data, cb) {
    ...
    async.waterfall([
        async.apply(storage.flushToStorage, { filename: pathDirname(filename), isDir: true })
    , function (cb) {
...
Persistence.prototype.loadDatabase = function (cb) {
  ...
  async.waterfall([
    function (cb) {
      Persistence.ensureDirectoryExists(pathDirname(self.filename), function (err) {
...
/***/ function(module, exports, __webpack_require__) {
    ...
    'use strict';
        ...
        var localForage = module.exports = {};
            ...
            localForage.ready = function ready(callback) {
                var self = this;
...
(function() {
  ...
  _.isEmpty = function(obj) {
    ...
    if (Array.isArray(obj) || _.isString(obj)) return obj.length === 0;
